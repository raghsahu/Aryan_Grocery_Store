    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
          ...
          //      mrpPrice.setText(map.get("Mrp"));
                ...
                args.putString("product_offer_image", modelList.get(position).getProduct_offer_image());
                args.putString("p_offer_description", modelList.get(position).getP_offer_description());
